    ...
    <Box
      ...
      <Box width='100%' mt={8} display='flex' justifyContent='center'>
        <FormControl className={classes.formControl} variant='outlined'>
          ...
          <Select labelId='demo-simple-select-label' id='country-select' value={bankCode} onChange={handleChange}>
      ...
      {isLoading ? (
        <Box justifyContent='center' display='flex' flexGrow='1' height='100%' flexDirection='column'>
          <Typography component='div'>
            <Box textAlign='center' fontSize='h6.fontSize' letterSpacing={3} lineHeight={1.0}>
        ...
        <Box display='flex' justifyContent='center' mt={4} flexDirection='column' alignItems='center' width='90%'>
          <Typography component='div'>
          ...
          <Button
            ...
            onClick={() => getBunq()}
            fullWidth={true}
            startIcon={<img src={process.env.PUBLIC_URL + '/images/bunq.ico'} alt='bunq' />}>
            Connect to bunq
          </Button>
        </Box>
      )}
